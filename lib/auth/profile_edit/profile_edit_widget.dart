          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: AuthUserStreamWidget(
                      builder: (context) => SizedBox(
                        width: 370.0,
                        child: TextFormField(
                          controller: _model.nomeComletoController,
                          ...
                          validator: _model.nomeComletoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                ...
                if (_model.nomeComletoController.text != '')
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 16.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.nomeComletoController.text != '') {
                          ...
                          await currentUserReference!
                              .update(createUsersRecordData(
                            displayName: _model.nomeComletoController.text,
                          ));
                          setState(() {
                            _model.nomeComletoController?.clear();
                          });
                        }
                      },
                      text: 'Salvar',
                ...
                if (_model.celularController.text != '')
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 16.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.celularController.text != '') {
                          ...
                          setState(() {
                            _model.celularController?.clear();
                          });
                        }
                      },
                      text: 'Salvar',
