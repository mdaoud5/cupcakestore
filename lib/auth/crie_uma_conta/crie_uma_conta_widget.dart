...
import 'crie_uma_conta_model.dart';
export 'crie_uma_conta_model.dart';

class CrieUmaContaWidget extends StatefulWidget {
  const CrieUmaContaWidget({super.key});

  @override
  _CrieUmaContaWidgetState createState() => _CrieUmaContaWidgetState();
}

class _CrieUmaContaWidgetState extends State<CrieUmaContaWidget> {
  late CrieUmaContaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrieUmaContaModel());

    _model.nomeComletoController ??= TextEditingController();
    _model.nomeComletoFocusNode ??= FocusNode();
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.nomeComletoController,
                                        focusNode: _model.nomeComletoFocusNode,
                                        autofocus: true,
                                        ...
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                        validator: _model
                                            .nomeComletoControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
