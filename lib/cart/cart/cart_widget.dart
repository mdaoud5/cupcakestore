                                          ...
                                          if (FFAppState()
                                            ...
                                            if (FFAppState().taxaDeIntrega !=
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Por favor insira seu endereço, No momento nossa entrega está limitada a 10 km.',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
