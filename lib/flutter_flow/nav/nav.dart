...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Entrar',
          path: '/entrar',
          builder: (context, params) => const EntrarWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          name: 'CrieUmaConta',
          path: '/crieUmaConta',
          builder: (context, params) => const CrieUmaContaWidget(),
        ),
        FFRoute(
          name: 'TermosCondicoes',
          path: '/termosCondicoes',
          builder: (context, params) => const TermosCondicoesWidget(),
        ),
        FFRoute(
          name: 'productPage',
          path: '/productPage',
